...
function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-hero-glow flex flex-col">
      ...
      <div className="flex-1 grid place-items-center px-4 pb-16">
        <div className="w-full max-w-md">
          <div className="flex items-center justify-center gap-2 mb-8">
            <div className="grid h-10 w-10 place-items-center rounded-lg bg-cta shadow-[var(--shadow-glow-violet)]">
          ...
          <div className="rounded-2xl border border-border bg-card p-8">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              {mode === "signup" ? "Save your history and access it anywhere." : "Sign in to see your file history."}
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" disabled={loading} className="w-full bg-cta hover:opacity-90 text-white border-0">
            ...
            <div className="text-center text-sm text-muted-foreground mt-6">
              ...
              <button onClick={() => setMode(mode === "signup" ? "login" : "signup")} className="text-foreground font-medium hover:underline">
